					...
					{!isLoading && !isRefetching && user && (
						<>
							...
							<div className='relative group/cover'>
								<img
									src={coverImg || user?.coverImg || "/cover.png"} alt='coverphoto'
								...
								<div className='avatar absolute -bottom-16 left-4'>
									<div className='w-32 rounded-full relative group/avatar'>
										<img src={profileImg || user?.profileImg || "/avatar-placeholder.png"} alt="profilePhoto"/>
							...
							<div className='flex justify-end px-4 mt-5'>
								...
								{(coverImg || profileImg) && (
									...
									>
										{isUpdateProfile && <LoadingSpinner size="sm" />}
										{!isUpdateProfile && "Update"}
									</button>
								)}
							</div>
